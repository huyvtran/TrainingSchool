<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/LMSSw.Master" CodeBehind="WFDoposcuola.aspx.vb" Inherits="TrainingSchool.WFDoposcuola" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="page-content">
        ...
        <p>In quest'area sarà possibile inviare una richiesta alla nostra segreteria, vi segnaleremo il docente che rispecchia le vostre necessità</p><div class="row">
        ...
        $.ajax({
            url: 'adminAjaxLMS.aspx?op=sendmaildoposcuola',
            type: 'POST',
            data: {  messaggio: $("#messaggio").val(), classe: $("#classe").val(),materia:$("#materia").val() },
            datatype: 'json',
