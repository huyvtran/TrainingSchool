<%@ Page Title="" Language="vb" ValidateRequest="false" AutoEventWireup="false" MasterPageFile="~/LMSSw.Master" CodeBehind="WFteacherAssign.aspx.vb" Inherits="TrainingSchool.WFAssignTeacher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>Assegnazione Classi-Docenti: <b> <%=Request.QueryString("title") %>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <table id="jqgrid_teachersassign"></table>
                <div id="pager_teachersassign"></div>
                <div id="toolbarteachers" class="clearfix form-actions">
                    <div class="col-md-offset-4 col-md-9">
                        <button id="btnAssignUser" class="btn btn-info" type="button">
                            <i class="icon-ok bigger-110"></i>
                            Assegna Docenti alla classe
                        </button>
    ...
    <script>
        ...
        jQuery(function ($) {
            ...
            var grid_selector2 = "#jqgrid_teachersassign";
            var grid_select = "#jqgrid_select";

            var pager_select = "#pager_select";
            var pager_selector2 = "#pager_teachersassign";
            ...
            var noth = true;
            var HeaderGrid;
            eaderGrid = "Docenti Assegnati"
            //if (oper == "teachersassigned") {
            //    HeaderGrid = "Docenti Assegnati"
            //    jQuery("#toolbarteachers").hide();
            //    checkavailable = true;
            //} else {
            //    HeaderGrid = "Docenti da assegnare"
            //    checkavailable = true;
            //}
            ...
            jQuery(grid_selector2).jqGrid({
                height: 'auto',
                url: ' AdminAjaxLMS.aspx?op=modteachers&oper=usersassigned&idcategory=' + idcategory,
                datatype: "json",
                ...
                loadComplete: function (data) {
                    ...
                    if (noth) {
                        ...
                        for (var i = 0; i < obj.length; i++) {
                            ...
                            var checkbox = $("#jqg_jqgrid_teachersassign_" + rowData.id);
                ...
                editurl: " AdminAjaxLMS.aspx?op=modteachers&oper=teachersdelete&idcategory=" + getParameterByName("idcategory"),
                caption: "Docenti Assegnati alla classe  <%=Request.QueryString("codice")%>"
            ...
            jQuery(grid_select).jqGrid({
                ...
                height: 'auto',
                datatype: "json",
                url: ' AdminAjaxLMS.aspx?op=modteachers&oper=usersavailable&idcategory=<%= Request.QueryString("idcategory")%>',
                ...
                viewsortcols: [true, 'vertical', true],
                viewrecords: true,
                caption: "Cerca Docenti da assegnare",
            ...
            jQuery("#btnAssignUser").on("click", function (e) {
                ...
                var urlsave = " AdminAjaxLMS.aspx?op=modteachers&oper=add&idcategory=<%=Request.QueryString("idcategory")%>&iduser=" + rowId;
